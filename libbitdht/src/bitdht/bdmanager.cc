...
#define TRANSITION_OP_SPACE_SIZE	2 /* 1 query / sec, should take 12-15 secs */
#define MAX_FINDSELF_TIME		20 /* increased, as std rate has been dropped */
